        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <x-input id="cpf" class="block mt-1 w-full" type="text" name="cpf" :value="old('cpf')" onkeypress="$(this).mask('000.000.000-00');" required />
                </div>
                <div class="col">
                    <x-label for="rg" value="RG" />
                    <x-input id="rg" class="block mt-1 w-full" type="text" name="rg" :value="old('rg')" onkeypress="$(this).mask('00.000.000-0');" required />
                </div>
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <x-input id="cep" class="block mt-1 w-full" type="text" name="cep" :value="old('cep')" onkeypress="$(this).mask('00.000-000')" required />
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <x-input id="celular" class="block mt-1 w-full" type="tel" name="celular" :value="old('celular')" onkeypress="$(this).mask('(00) 0000-00009')" required />
                </div>
            </div>
